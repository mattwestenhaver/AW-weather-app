This project was created through [React](https://github.com/facebookincubator/create-react-app) and is deployed on [Heroku](https://aw-weather-westenhaver.herokuapp.com/).
